...
export default function NoticiaDetallePage() {
  ...
  const announcementId = hasValidParams ? (params.id as string) : '';
  const announcement = hasValidParams ? getAnnouncementById(announcementId) : undefined;
  ...
  useEffect(() => {
    ...
    if (hasValidParams && announcement === undefined) {
      const timer = setTimeout(() => {
        router.push("/noticias");
      }, 3000);
  ...
  }, [hasValidParams, announcement, router]);
